...
cp ${CODE}/*_script_design_lvl2_wPreStim.fsf \
   ${DERIV}/${subj}/func/DesignFiles/design_lvl2_wPreStim.fsf
...
/usr/local/fsl/bin/feat ${DERIV}/${subj}/func/DesignFiles/design_lvl2_wPreStim.fsf
